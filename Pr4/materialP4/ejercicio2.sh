...
plot "ej2/pesc_serie_media.dat" using 1:2 with lines lw 2 title "p_serie", \
     "ej2/pesc_paralelo_0.dat" using 1:2 with lines lw 2 title "p_par_1", \
     "ej2/pesc_paralelo_1.dat" using 1:2 with lines lw 2 title "p_par_2", \
     "ej2/pesc_paralelo_2.dat" using 1:2 with lines lw 2 title "p_par_3", \
     "ej2/pesc_paralelo_3.dat" using 1:2 with lines lw 2 title "p_par_4"
replot
quit
END_GNUPLOT
