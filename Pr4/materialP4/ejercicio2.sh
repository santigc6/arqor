...
awk -v "n=$reps" '{valores[$1]+=$2} END{for(i in valores) print i" "valores[i]/n}' ej2/pesc_paralelo_0.dat | sort -nk1 > ej2/pesc_paralelo_0_media.dat
...
plot "pesc_serie_media.dat" using 1:2 with lines lw 2 title "p_serie", \
     "pesc_paralelo_0_media.dat" using 1:2 with lines lw 2 title "p_par_1", \
     "pesc_paralelo_1_media.dat" using 1:2 with lines lw 2 title "p_par_2", \
     "pesc_paralelo_2_media.dat" using 1:2 with lines lw 2 title "p_par_3", \
     "pesc_paralelo_3_media.dat" using 1:2 with lines lw 2 title "p_par_4"
replot
quit
END_GNUPLOT
