...
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 1 | grep Tiempo | awk '{print $2}' >> m.txt
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 2 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 4 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 6 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 7 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 8 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 9 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 10 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
...
> m.txt
for((i=1 ; i <= 50 ; i = i+1)); do
    ./pi_par3 12 | grep Tiempo | awk '{print $2}' >> m.txt
    echo "Realizada la ejecución número "$i
done
